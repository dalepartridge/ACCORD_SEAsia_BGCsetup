...
###############
cd woa18
ln -s $RAWDATA/ICS/woa18_nitrate_extracted_mean.nc .
ln -s $RAWDATA/ICS/woa18_phosphate_extracted_mean.nc .
ln -s $RAWDATA/ICS/woa18_silicate_extracted_mean.nc .
...
###############
cd woa18-oxy
ln -s $RAWDATA/ICS/woa18_oxy_extracted_mean.nc .
ln -s $DOMAINFILE domain_cfg.nc
...
###############
cd glodap
ln -s $RAWDATA/ICS/GLODAP_TAlk_extracted.nc .
ln -s $RAWDATA/ICS/GLODAP_TCO2_extracted.nc .
ln -s $DOMAINFILE domain_cfg.nc
ln -s $TOOLS/interp-files/interp_IC_*.sh .
...
###############
cd occci
ln -s $RAWDATA/ICS/CCI-OC_chla_extracted_jan_mean.nc .
ln -s $DOMAINFILE domain_cfg.nc
ln -s $TOOLS/interp-files/interp_IC_initial.sh .
...
###############
cd ady
ln -s $RAWDATA/ICS/adyBroadBandClimatology_ACCORD_extracted.nc .
ln -s $DOMAINFILE domain_cfg.nc
ln -s $TOOLS/interp-files/interp_IC_initial.sh .
